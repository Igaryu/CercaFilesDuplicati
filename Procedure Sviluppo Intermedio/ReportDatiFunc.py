...
def ReportDati():
	...
	duplicato=0
	for elemento_selezionato_esterno in data_base.execute("select * from Duplicati;"): 
		...
		for elemento_selezionato_interno in data_base.execute(f"select * from Duplicati where indiceSrc={duplicato};"): 
