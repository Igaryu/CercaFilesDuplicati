...
def ReportDati():
	...
	duplicato=0
	for elementoSelezionatoEsterno in dataBase.execute("select * from Duplicati;"): 
		...
		for elementoSelezionatoInterno in dataBase.execute(f"select * from Duplicati where indiceSrc={duplicato};"): 
