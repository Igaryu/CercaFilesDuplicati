...
def cls():
    '''
    	Definisce come pulire lo schermo dopo aver identificato il S.O.
	'''
    if os.name == 'posix':
        os.system('clear')
    else:
...
def check_dir_to_scan(home_dir: str, dir_to_scan: str):
    '''
    Se il parametro esiste, come percorso assoluto, lo restituisce;
    ...
    Se entrambe le situazioni non sono vere, segnala l'inesitenza della
